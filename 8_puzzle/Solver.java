...
public class Solver {
    ...
    public Solver(Board board) {
        // corner cases Not sure why they werent working
        if (board == null){
        ...
        // priority queue for search nodes and insert intitial board as the starting node
        ...
        while(!pq.isEmpty()){
            ...
            if(node.board.isGoal()){
                // initialize solution stack
                solution = new LinkedStack<Board>();

                //go back and push each board to solution stack
                while (node != null && node.board != board){
                ...
                //once solution found then exit
                break;
            }

            //considers all boards around
    ...
    private class SearchNode implements Comparable<SearchNode> {
        ...
        public int compareTo(SearchNode other) {
            return Integer.compare(this.board.manhattan()+ this.moves, other.board.manhattan()+ other.moves);
        }
    }
